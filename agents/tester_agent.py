...
class TesterAgent(Agent):
    ...
    def test(self, contract: Dict[str, Any], python_code: str, reverty_code: str, tests: str, error_output: str) -> Dict[str, Any]:
        """
        ...
        if test_result.status == Status.SUCCESS:
            ...
            tester_prompt = generate_tester_request(contract, python_code, reverty_code, tests, failed_tests, error_output)

            response = self.client.generate(
                user_prompt=tester_prompt,
